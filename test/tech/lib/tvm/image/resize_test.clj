(ns tech.lib.tvm.image.resize-test
  (:require [clojure.test :refer :all]
            [tech.lib.tvm.image.resize :as resize]
            [tech.compute.verify.tensor :as vf]
            [tech.compute :as compute]
            [tech.lib.tvm :as tvm]
            [tech.lib.tvm.cpu :as cpu]
            [tech.lib.tvm.compile-test :as compile-test]
            [clojure.core.matrix :as m]
            [tech.compute.tensor :as ct]
            [tech.compute.tensor.defaults :as ct-defaults]
            [tech.datatype.base :as dtype]
            [tech.core.resource :as resource]
            [tech.lib.opencv :as opencv]
